...
import com.example.demo.controllers.UserDoesntExistException;
...
public class UserService implements UserDetailsService{
    ...
    @Autowired
    public UserService(UserRepo userRepo,@Lazy PasswordEncoder passwordEncoder){ this.userRepo = userRepo; this.passwordEncoder = passwordEncoder;}
